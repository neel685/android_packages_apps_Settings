...
public class StorageItemPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    private long getPhotosSize(StorageAsyncLoader.AppsStorageResult appsStorageResult, StorageAsyncLoader.AppsStorageResult appsStorageResult2) {
        ...
        StorageStatsSource.ExternalStorageStats externalStorageStats2;
        if (appsStorageResult2 != null && appsStorageResult != null && (externalStorageStats2 = appsStorageResult.externalStats) != null) {
            long j = appsStorageResult.photosAppsSize + externalStorageStats2.imageBytes + externalStorageStats2.videoBytes + appsStorageResult2.photosAppsSize;
            StorageStatsSource.ExternalStorageStats externalStorageStats3 = appsStorageResult2.externalStats;
            return j + externalStorageStats3.imageBytes + externalStorageStats3.videoBytes;
        } else if (appsStorageResult == null || (externalStorageStats = appsStorageResult.externalStats) == null) {
            return 0;
        } else {
            return appsStorageResult.photosAppsSize + externalStorageStats.imageBytes + externalStorageStats.videoBytes;
        }
    }
