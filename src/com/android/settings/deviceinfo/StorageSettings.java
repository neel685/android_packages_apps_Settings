...
public class StorageSettings extends SettingsPreferenceFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ...
            searchIndexableRaw.title = context.getString(C0017R$string.internal_storage);
            ((SearchIndexableData) searchIndexableRaw).key = "storage_settings_internal_storage";
            ...
            for (VolumeInfo volumeInfo : storageManager.getVolumes()) {
                if (StorageSettings.isInteresting(volumeInfo)) {
                    searchIndexableRaw2.title = storageManager.getBestVolumeDescription(volumeInfo);
                    ((SearchIndexableData) searchIndexableRaw2).key = "storage_settings_volume_" + volumeInfo.id;
            ...
            searchIndexableRaw3.title = context.getString(C0017R$string.memory_size);
            ((SearchIndexableData) searchIndexableRaw3).key = "storage_settings_memory_size";
            ...
            searchIndexableRaw4.title = context.getString(C0017R$string.memory_available);
            ((SearchIndexableData) searchIndexableRaw4).key = "storage_settings_memory_available";
            ...
            searchIndexableRaw5.title = context.getString(C0017R$string.memory_dcim_usage);
            ((SearchIndexableData) searchIndexableRaw5).key = "storage_settings_dcim_space";
            ...
            searchIndexableRaw6.title = context.getString(C0017R$string.memory_music_usage);
            ((SearchIndexableData) searchIndexableRaw6).key = "storage_settings_music_space";
            ...
            searchIndexableRaw7.title = context.getString(C0017R$string.memory_media_misc_usage);
            ((SearchIndexableData) searchIndexableRaw7).key = "storage_settings_misc_space";
            ...
            searchIndexableRaw8.title = context.getString(C0017R$string.storage_menu_free);
            ((SearchIndexableData) searchIndexableRaw8).key = "storage_settings_free_space";
            searchIndexableRaw8.screenTitle = context.getString(C0017R$string.storage_menu_free);
            ((SearchIndexableData) searchIndexableRaw8).intentAction = "android.os.storage.action.MANAGE_STORAGE";
            searchIndexableRaw8.keywords = context.getString(C0017R$string.keywords_storage_menu_free);
